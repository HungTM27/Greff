            ...
            <div class="auth-form-light text-left pt-2 px-5">
                ...
                <form class="pt-3" method="POST" action="{{route('reset-password')}}">
                    ...
                    <div class="form-group border border-secondary bg-white mx-4 mt-3 px-2">
                        ...
                        <input type="text" value="{{ $email ?? old('email') }}" class="form-control form-control-md py-2 border-0" name="email" value="">
                    </div>
                    ...
                    <div class="form-group border border-secondary bg-white mx-4 mt-3 px-2">
                        <label class="col-sm-2 control-label text-black-50"> Password Confirm </label>
                    ...
                    <div class="form-group mt-2 mb-5 mx-4">
                        <button class="btn col-md-12 text-center text-light" style="background-color: #3f96c5;" name=login"> Reset Password </button>
                    </div>
                </form>
            </div>
        </div>
