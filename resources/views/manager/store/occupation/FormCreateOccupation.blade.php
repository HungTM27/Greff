    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body pb-5">
                <div class="container">
                    <form action="{{ route("occupation.create") }}" enctype="multipart/form-data" id="formOccupation" method="POST">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="textbox" class="form-control" id="title" name="title" value="{{ old('title') }}">
                            <div id="er_note" class="text-danger d-block mt-1 mb-1" ></div>
                            @error('title')
                                <div class="text-danger d-block mt-1 mb-1">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea class="form-label col-12" name="description" id="description" rows="3" >{{ old('description') }}</textarea>
                            @error('description')
                                <div class="text-danger d-block mt-1 mb-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input class="col-12" type="textbox" name="work_address" id="work_address" value="{{ old('work_address') }}">
                            @error('work_address')
                                <div class="text-danger d-block mt-1 mb-1">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea class="form-label col-12" name="access_address" id="access_address" rows="3">{{ old('access_address') }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="speciality[]" id="speciality" class="js-example-basic-single col-12" >
                                ...
                                <option value="2">残業なし</option>
                                <option value="残業なし">お祝い金</option>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-label col-12" name="note" id="note" rows="3">{{ old('note') }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="bring_item" class="form-label col-12 p-0">Bring items</label>
                            <textarea class="form-label col-12" name="bring_item" id="bring_item" rows="3">{{ old('bring_item') }}</textarea>
                        </div>
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-8">
                                    ...
                                    <div class="form-group">
                                        <input class="form-label col-12 w-50" type="text" name="id_skill_required[]" id="id_skill_required_0">
                                    </div>
                                    <div id="addtextnow"></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <input class="form-check-input" type="radio" value="0" name="status" id="status2" checked>
                        ...
                        <div class="d-md-flex justify-content-md-end">
                            <button type="button" class="btn btn-secondary text-light me-md-2 col-1" ><a href="/showCreateOccupation" style="text-decoration: none;color: white;">Cancel</a></button>
