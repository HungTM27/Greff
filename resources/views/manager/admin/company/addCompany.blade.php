                                        ...
                                        <form action="{{ route('addCompany') }}" method="POST">
                                            ...
                                            <div class="col-md-12 row mb-3">
                                                <div class="col-md-6 pr-1 pl-0">
                                                    <div class="form-group border border-secondary bg-white pl-0 mb-1">
                                                        ...
                                                        <input type="text" class="form-control form-control-md border-0 px-2" name="company_name" value="{{ old('company_name') }}">
                                                    </div>
                                                ...
                                                <div class="col-md-6 pr-0 pl-1">
                                                    <div class="form-group border border-secondary bg-white pl-0">
                                                        ...
                                                        <input type="text" class="form-control form-control-md border-0 px-2" name="company_name_kana" value="{{ old('company_name_kana') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 row mb-3">
                                                <div class="col-md-6 pr-1 pl-0">
                                                    <div class="form-group border border-secondary bg-white pl-0 mb-1">
                                                        ...
                                                        <input type="text" class="form-control form-control-md border-0 px-2" name="register_name" value="{{ old('register_name') }}">
                                                    </div>
                                                    <span class="fw-light text-danger"> @error('register_name') {{ $message }}@enderror </span>
                                                </div>
                                                <div class="col-md-6 pr-0 pl-1">
                                                    <div class="form-group border border-secondary bg-white pl-0">
                                                        <label class="control-label text-black-50 px-2 mb-0"> Register name (kana) </label>
                                                        <input type="text" class="form-control form-control-md border-0 px-2" name="register_name_kana" value="{{ old('register_name_kana') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 row mb-3">
                                            ...
                                            <div class="col-md-12 row mb-3">
                                                <div class="col-md-6 pr-1 pl-0">
                                                    <div class="form-group border border-secondary bg-white pl-0 mb-1">
                                                        ...
                                                        <input type="text" class="form-control form-control-md border-0 px-2" name="room" value="{{ old('room') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 pr-0 pl-1">
                                                    <div class="form-group border border-secondary bg-white pl-0">
                                                        <label class="control-label text-black-50 px-2 mb-0"> Building </label>
                                                        <input type="text" class="form-control form-control-md border-0 px-2" name="building" value="{{ old('building') }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12 row mb-3">
                                                <div class="col-md-6 pr-1 pl-0">
                                                    <div class="form-group border border-secondary bg-white pl-0 mb-1">
                                                        ...
                                                        <input type="text" class="form-control form-control-md border-0 px-2" name="zipcode" value="{{ old('zipcode') }}">
                                                    </div>
                                            ...
                                            <div class="col-md-12 row mb-3">
                                                <div class="col-md-12 form-group border border-secondary bg-white pl-0 mb-1">
                                                    ...
                                                    <textarea type="text" class="form-control form-control-md border-0 px-2" name="note" value="{{ old('note') }}"></textarea>
                                                </div>
                                            </div>
